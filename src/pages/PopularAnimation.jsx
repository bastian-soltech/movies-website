...
export default function PopularAnimationPage() {
        ...
        const fetchPopular = async () => {
          ...
          try {
            const response = await fetch(
              `https://nonton-yuk-api.vercel.app/api/hot-movies/3/${currentPage}`
            );
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-32 pb-24">
        ...
        <div className="mb-16 space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-white leading-none">
            Popular <span className="text-blue-500">Animation</span>
          </h1>
