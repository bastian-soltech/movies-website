...
export default function PopularAnimation({popularAnimation, source="filmapik"}) {
    if (!popularAnimation || !popularAnimation.length) {
        return (
          <div className="mt-10 mx-4 md:mx-10 h-64 flex items-center justify-center">
            <div className="text-center space-y-4">
              <div className="w-12 h-12 border-4 border-blue-500 border-t-transparent rounded-full animate-spin mx-auto"></div>
              <p className="text-slate-400">Loading popular animation...</p>
            </div>
          </div>
        );
      }
          ...
          <div className="container mx-auto">
            ...
            <div className="relative">
              ...
              <div className="relative h-auto min-h-[300px] md:min-h-[400px]">
                <MoviesSlide
                  movies={popularAnimation}
                  renderSlide={(movie, index) => <MoviesCard id={movie.resource_info.enid} movieTitle={movie.resource_info.process_name} posterUrls={movie.share_info.cover.url3} />}
                />
              </div>
            </div>
          </div>
